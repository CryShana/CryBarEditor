...
namespace CryBar.BCnEncoder.Encoder
{
    ...
    internal static class LeastSquares
    {
        ...
        {
            return Shared.Half.GetBits(new Shared.Half(f32));
        }
        ...
        {
            return Shared.Half.ToHalf((ushort)f16);
        }
        ...
        public static void OptimizeEndpoints1Sub(RawBlock4X4RgbFloat block, ref ColorRgbFloat ep0, ref ColorRgbFloat ep1)
        {
            ...
            if (MathF.Abs(det) > 0.00001f)
            {
                ...
                ep0f16 = Vector3.Clamp(ep0f16, Vector3.Zero, new Vector3(Shared.Half.MaxValue.Value));
                ep1f16 = Vector3.Clamp(ep1f16, Vector3.Zero, new Vector3(Shared.Half.MaxValue.Value));

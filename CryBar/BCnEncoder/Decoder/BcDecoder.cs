#pragma warning disable CS8602, CS8603, CS8765, CS0649, CS0162, CS8600, CS8618

using System.Runtime.CompilerServices;
using CryBar.BCnEncoder.Shared;
using CryBar.BCnEncoder.Decoder.Options;
using CryBar.BCnEncoder.Shared.ImageFiles;
using CommunityToolkit.HighPerformance;

namespace CryBar.BCnEncoder.Decoder
{
    /// <summary>
    ...
    public class BcDecoder
    {
        ...
        /// To get the block size (in bytes) of the compression format used, see <see cref="GetBlockSize(CompressionFormat)"/>.
        /// </summary>
